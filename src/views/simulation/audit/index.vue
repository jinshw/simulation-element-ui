...
<script>
import { getCollectionDataListNotPage, sceneList, addScene, editScene, deleteScene, imgUpload, sceneFileDownLoad, getPreviewFileUrl, getSceneTypeTree } from '@/api/simulation'
