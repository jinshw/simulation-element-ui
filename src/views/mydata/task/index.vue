...
<script>
import { findDistributionList, addTask, deleteTask, editTask, addTaskUser } from '@/api/simulation'
...
export default {
  ...
  methods: {
    ...
    getTasks: function(pageNum, pageSize) {
      ...
      findDistributionList(this.searchObj).then(response => {
