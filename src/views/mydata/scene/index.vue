...
<script>
import { findCdDatasDistributionList, mySceneList, addScene, editScene, deleteScene, imgUpload, getPreviewFileUrl, getSceneTypeTree, addSceneUser } from '@/api/simulation'
